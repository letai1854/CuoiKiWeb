<?php
    ...
    $id=$_GET['sid'];
    $thongtin = Research::getResearchById($id);
...
<div class="c1" >
    <div class="container">
        <div class="titleh1">
            <?php
              if ($thongtin && isset($thongtin[0]['title'])) {
                  echo '<h2>'.htmlspecialchars($thongtin[0]['title']).'</h2>';
              } else {
    ...
    <div class="container">
        <div class="row">
            ...
            <?php
                if ($thongtin && isset($thongtin[0]['content'])) {
                    echo $thongtin[0]['content'];
                } else {
                    echo 'Error'; 
                }
            ?>
