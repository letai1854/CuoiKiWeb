            ...
            foreach ($list_subject as $item) {
                ...
                echo '<div class="news-item">
                        ...
                        <div class="news-content">
                            <a class="thea" href="./noidungthongbao.php?sid='.htmlspecialchars($item['id']).'">
                ...
                <ul>
                    ...
                    if(isset($list_thongbao))
                    {
                        if(is_array($list_thongbao))
                        {
                            ...
                            {
                                echo '<li><a class="thongbaopanel" href="./noidungthongbao.php?sid='.htmlspecialchars($item['id']).'">'.htmlspecialchars($item['infoTitle']).'<br><span class="date">'.htmlspecialchars($item['day']).'</span> <span class="new">mới</span></a></li>';
                            }
                        }
                    }
                    ?>
