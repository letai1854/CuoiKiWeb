            ...
            foreach ($list_subject as $item) {
                ...
                echo '<div class="news-item">
                        ...
                        <div class="news-content">
                            <a class="thea" style="text-decoration: none; color: black;" href="./noidungtintuc.php?sid='.htmlspecialchars($item['id']).'">
...
<body>
    ...
    <div class="container container1">
        <div class="row ">
            ...
            <div class="col-lg-8 col-md-12 col-12">
                <div class="title">
                    <div class="subject">
                        <h2 style="color:red;font-weight: bold;"><i class="fas fa-newspapers"></i>  Tin tức</h2>
                    </div>
                ...
                if(isset($_POST['btntimkiem'])){
                    ...
                    $key=$_POST['tim'];
                    if(!empty($key)){
                        $list_LimitSubject=thongTin::getSearchNewstDetail($key,'tintuc',$item_per_page,$offset);
                        $totalSubject=count(thongTin::countSearchNewstDetail($key,'tintuc'));
                    }
                }
                if($checkTim==true)
                {
                ...
                if(!empty($key)){
                    ...
                    $checkTim=false;
                    $list_LimitSubject=thongTin::getListThongTinByTypeLimit('tintuc',$item_per_page,$offset);
                    $totalSubject=count(thongTin::getListThongTinByType('tintuc'));
                }
    ...
    <?php }?>
            ...
            <div class="col-lg-4 col-md-12 col-12 sidebar">
                <h5><i class="fas fa-newspaper"></i> Tin tức mới</h5>
                <br>
                <ul>
                    <?php
                    $list_thongbao = ThongTin::getListThongTinByTypeLimit8("tintuc");
                    if(isset($list_thongbao))
                    {
                        if(is_array($list_thongbao))
                        {
                            ...
                            {
                                echo '<li><a href="./noidungtintuc.php?sid='.htmlspecialchars($item['id']).'">'.htmlspecialchars($item['infoTitle']).'<br><span class="date">'.htmlspecialchars($item['day']).'</span> <span class="new">mới</span></a></li>';
                            }
                        }
                    }
                    ?>
